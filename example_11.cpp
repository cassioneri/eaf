 ...
 * @file example_11.cpp
 *
 * @brief Command line program that confirms claim of example 11.
 *
...
int main() {
    ...
    for (int32_t n = 0; n < 28825529; ++n) {
        ...
        int32_t const rhs = static_cast<int32_t>(
            int64_t(2939745) * n / 4294967296);
    ...
    for (uint32_t n = 0; n < 28825529; ++n) {
        ...
        uint32_t const rhs = static_cast<uint32_t>(int64_t(2939745) * n /
            4294967296);

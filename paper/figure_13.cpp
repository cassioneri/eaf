...
/**
 * @file algorithm_04.cpp
 *
 * @brief Command line program that runs algorithm 4.
 *
...
int main(int argc, char* argv[]) {
  ...
  rata_die_type const N    = gregorian::to_rata_die_opt
    <rata_die_type, 719468, 82>(date.year, date.month, date.day);

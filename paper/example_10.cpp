 ...
 * @file example_10.cpp
 *
 * @brief Command line program that confirms claim of example 10.
 *
...
int main() {
    ...
    for (int32_t N_Y = 0; N_Y < 734; ++N_Y) {
        ...
        int32_t const lhs = (5 * N_Y + 461) / 153;
        int32_t const rhs = (2141 * N_Y + 197913) / 65536;
    ...
    for (uint32_t N_Y = 0; N_Y < 734; ++N_Y) {
        ...
        uint32_t const lhs = (5 * N_Y + 461) / 153;
        uint32_t const rhs = (2141 * N_Y + 197913) / 65536;
